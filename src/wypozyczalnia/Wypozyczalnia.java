...
import wypozyczalnia.exceptions.*;
...
public class Wypozyczalnia {
    ...
    private static void menu(VehiclesBase vbase,ClientBase cbase, RentBase rbase) {
		...
		String option;
		do  {
			System.out.print("Witaj w wypozyczalni!\nMenu: \n [1] Klienci\n [2] Pojazdy\n [3] Wypozyczenia\n [0] Wyjscie\nZatwierdz - enter \n");
			option = sc.nextLine();
			switch (option) {
			case "1": {
                                String option2;
    ...
    private static void addPassengerCarOption(VehiclesBase base, Scanner sc) {
		...
		try {
			...
			System.out.println("Pojazd o podanym numerze rejestracyjnym juz istnieje");
		}
		wait(sc);
	}
    ...
    private static void addLightTruckOption(VehiclesBase base, Scanner sc) {
		...
		try {
			...
			System.out.println("Pojazd o podanym numerze rejestrecyjnym juz istnieje");
		}
		wait(sc);
	}
    ...
    private static void addMotorcycleOption(VehiclesBase base, Scanner sc) {
		...
		try {
			...
			System.out.println("Podanym numerze rejestracyjnym juz istnieje");
		}
		wait(sc);
	}
    ...
    private static void removeClientOption(ClientBase base, Scanner sc) {
		...
		try {
			...
			System.out.println("Nie  ma klienta o podanym peselu w bazie ");
		}
		wait(sc);
	}
    ...
    private static void run() throws ClassNotFoundException, IOException {
		final String NAZWA_PLIKU_DANYCH= "dane_pojazdy.txt";
                final String NAZWA_PLIKU_DANYCH2= "dane_klienci.txt";
                final String NAZWA_PLIKU_DANYCH3= "dane_wypozyczenia.txt";
